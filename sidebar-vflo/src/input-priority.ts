...
// Vendored from tool-expansion's src/input-priority.ts (same author, same repo
// family). split-pane.ts has a near-identical private helper, but it is
// function-scoped inside createSplitPaneController and not exported, so this
// small module is duplicated here rather than reaching into that closure.
